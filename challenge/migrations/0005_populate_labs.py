...
def populate_default_labs(apps, schema_editor):
...
def remove_default_labs(apps, schema_editor):
    Lab = apps.get_model('challenge', 'Lab')
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(populate_default_labs, reverse_code=remove_default_labs),
    ]
