...
urlpatterns = [
    ...
    path("xss_target",views.xss_target,name="XSS LAB"),
    path('pxss', views.xss_p_lab,name="xss_p_lab"),
    path('dxss', views.xss_d_lab,name="XSS LAB"),
    path('xssL',views.xss_r_lab,name='XSS LAB'),
    path('xssL1',views.xss_r_lab,name='XSS LAB'),
    ...
    path("insecure-design",views.insec_design,name="insecure-design"),
    path("insecure-design_lab",views.insec_design_lab,name="insecure-design_lab"),
    path("insecure-design_lab2",views.insec_design_lab2,name="insecure-design_lab2"),
